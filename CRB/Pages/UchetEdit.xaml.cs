...
namespace CRB.Pages
{
    ...
    {
		public UchetEdit()
        {InitializeComponent();DataContext = CurElMedCard.card ?? new Electronic_medical_card();if(CurElMedCard.card.Outcomes.id_outcomes != 1) { EpBtn.Visibility = Visibility.Collapsed; }}
		private void EditBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            }ConnectDB.GetCont().SaveChanges();Nav.frame.GoBack();          }
